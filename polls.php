...
<body>
    ...
    if (isset($_POST["submit"])) {
        ...
        if ($result->num_rows > 0) {
            ...
            $poll_id = $_POST["poll_id"];
            $answer = $_POST["answer_{$poll_id}_1"];
            $answer = $_POST["answer_{$poll_id}_2"];
    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
            ...
            echo "<form action='#' method='post' class='poll-area'>";
                echo "<input type='checkbox' name='answer_{$row['id']}_1' id='opt-1' value='" . $row["answer_1"] . "'>";
                ...
                echo "</label>";
                echo "<input type='checkbox' name='answer_{$row['id']}_2' id='opt-2' value='" . $row["answer_2"] . "'>";
